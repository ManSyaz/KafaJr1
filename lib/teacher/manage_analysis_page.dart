  ...
  Future<void> _analyzeGrades() async {
    ...
    try {
      ...
      if (snapshot.exists) {
        ...
        // Use a Set to track unique studentIds to prevent duplicate counting
        final Set<String> countedStudents = {};
        
        progresses.forEach((_, value) {
          final progress = Map<String, dynamic>.from(value as Map);
          final studentId = progress['studentId'] as String;
          
          // Only count if we haven't seen this student for this subject/exam combination
          if (progress['subjectId'] == selectedSubject && 
              progress['examId'] == selectedExam &&
              !countedStudents.contains(studentId)) {
